...
def main():
    ...
    base = Path(r"C:\Users\wren9\git\coderintheloop\data\postgres") # CSV files location
    ...
    with psycopg.connect(**conninfo) as conn, conn.cursor() as cur:
        ...
        for name, schema_path, csv_path, delim, drops, dstyle in tables:
            try:
                ...
                load_table(cur, name, str(schema_path), str(csv_path), delimiter=delim, drop_cols=drops, date_style=dstyle)
